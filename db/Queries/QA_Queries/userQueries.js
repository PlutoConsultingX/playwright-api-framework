...
import { executeQuery } from "../dbClient.js";
...
export async function getSalaryTransactionFailedSAGResponse(clientCorrelationID) {
  const query = `
  ...
  `;
  return await executeQuery(query, [clientCorrelationID]);
}